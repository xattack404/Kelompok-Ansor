...
Route::get('informasi/index', ['as' => 'frontend.informasi.index', 'uses' => 'informasiController@index']);
...
Route::get('panel/manejemenatlet/detail/{nik_id}', ['as' => 'manejemenatlet.detail', 'uses' => 'ManejemenAtletController@show']);
...
Route::get('panel/manejemenkomunitas/detail/{id}', ['as' => 'manejemenkomunitas.detail', 'uses' => 'ManejemenKomunitasController@show']);
...
Route::get('panel/pembayaran/hapus/{no_invoice}', ['as' => 'pembayaran.hapus', 'uses' => 'PembayaranController@pembayaranHapus']);
Route::get('panel/pembayaran/popgambar/{no_invoice}', ['as' => 'pembayaran.popgambar', 'uses' => 'PembayaranController@LoadImage']);
